...
<div class="content-wrapper">
  ...
  @endif
    <section class="content container-fluid">
        <div class="col-md-12">
            <form action="/admin/blog/{{ $post->id }}/edit" method="post">
              @csrf
              @method('put')
                ...
                <div class="form-group">
                    <label for="">متن</label>
                    <textarea id="editor1" name="text" rows="10" cols="80" >{{ $post->text }}</textarea>
                </div>
                <div class="form-group">
                    <label for="sel1">دسته بندی</label>
                    <select name="slug" class="form-control" id="sel1" >
                      <option>{{ $post->slug }}</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block">ارسال نوشته</button>
                </div>
            </form>
        </div>
    </section>
